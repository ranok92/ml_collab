        ...
        for sentence in sentences:
            ...
            for word in word_list:
                ...
                if word not in stop_words:
                    ...
                    filtered_sentence.append(re.sub(char_pattern, '', word.lower()))
...
def get_cbow_training_tuples(word_list, context_window=2):
    ...
    for i in range(sentence_length):
        ...
        if sentence_length>1:
            ...
            context_window_right_limit = min(sentence_length-1, i+context_window)
...
if __name__=='__main__':
    ...
    pdb.set_trace()
    '''
    create_cbow_dataset('./mini_gutenberg.json', 'cbow_style_training_dataset.json')
